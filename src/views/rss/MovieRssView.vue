...
<template>
  <div class="rss-index page">
    ...
    <van-empty v-else-if="filteredItems.length === 0" :description="activeTab === 'MOV' ? '当前没有正在订阅的电影。' : '当前没有正在订阅的电视剧。'" />
...
<style scoped>
.rss-index { padding: 8px 10px; display: flex; flex-direction: column; gap: 10px; }
