...
export function mediaRecommendations(type: string, tmdbid: string | number, page = 1): Promise<MediaListResult> {
...
export function personMedias(personid: string | number, type?: string, page = 1): Promise<MediaListResult> {
